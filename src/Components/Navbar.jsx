    ...
    <div className='navbar'>
     <div className='sm:hidden'> 
      ...
      {isNavbarVisible ? <RxCross1 className='hover:text-[#6849f3]' size={26} /> : <RxHamburgerMenu className='hover:text-[#6849f3]'  size={26} />}
          ...
          <a href='../public/File/Resume.pdf' download='Resume.pdf' onClick={closeNavbar} className='text-2xl tracking-widest sm:tracking-normal sm:text-base mb-1 sm:mr-3 sm:mb-0' to='/'>Resume</a>
