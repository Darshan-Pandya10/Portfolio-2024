    ...
    <div className="navbar">
      <div className="sm:hidden">
        <button onClick={handleNavbar} className="absolute top-4 right-4">
          {isNavbarVisible ? (
            <RxCross1 className="hover:text-[#6849f3]" size={26} />
          ) : (
            <RxHamburgerMenu className="hover:text-[#6849f3]" size={26} />
          )}
        </button>
      </div>
      <nav
      ...
      >
        <a
          href="#experience"
          onClick={closeNavbar}
          className="text-2xl tracking-widest sm:tracking-normal sm:text-base mb-1 sm:mr-3 sm:mb-0"
        >
          Experience
        </a>
        <a
