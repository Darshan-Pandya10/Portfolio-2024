...
const ExperienceCard = ({experience}) => {
  ...
  return (
    <div className="experience-card cursor-pointer hover:border-[#6849f3] relative m-4  md:m-12 p-8 bg-black border-2 border-white border-solid md:w-[35rem] rounded-lg shadow-lg">
