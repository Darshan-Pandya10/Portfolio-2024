...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="group p-2 min-w-[21rem] md:min-w-[24rem] h-[15rem] cursor-pointer bg-[#1E2022] text-white m-6 overflow-hidden shadow-lg relative">
    <img className="w-[20rem] md:w-[23rem] h-full object-fill  object-center" src={img} alt={title} />
    <div className="details p-4 absolute inset-0 flex flex-col items-center justify-center text-center transition-opacity duration-300 opacity-0 group-hover:opacity-100 bg-[rgba(0,0,0,0.8)] backdrop-blur-[8px]">
        ...
        <p className='text-gray-400 text-xl mb-4 tracking-wider'>{tag}</p>
