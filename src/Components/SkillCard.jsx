...
const SkillCard = ({skill}) => {
  ...
  return (
    <div className="rounded-lg cursor-pointer hover:scale-105 bg-black shadow-lg p-4 w-[8rem] md:w-[10rem] mx-2 my-2 hover:shadow-base hover:shadow-[#6849f3] transition-shadow">
