...
const WorkExperienceCard = ({ job }) => {
  ...
  return (
    <article className="glass-card relative w-full max-w-4xl mx-auto my-4 sm:my-6 p-5 sm:p-8 md:p-10 rounded-xl hover:-translate-y-0.5 transition-transform duration-300">
