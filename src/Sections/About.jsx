      ...
      <div className="typewriter mt-3 flex items-center justify-center">
        ...
        <Typewriter
          options={{
            ...
            loop: true,
            delay: 50,
            strings: [" Darshan Pandya.", " a MERN stack Developer."],
            wrapperClassName:
              "text-xl md:text-2xl font-semibold text-[#6849f3]",
          }}
        />
      </div>
      <p className="text-base md:w-[45rem] my-4 tracking-wider leading-7 text-center">
        Dedicated to refining skills and delivering impactful web experiences.
        Proficient in <span className="text-[#6849f3] font-bold">MERN</span> and{" "}
        <span className="text-[#6849f3] font-bold">React</span> , with a
        commitment to continuous learning and staying abreast of industry
        trends.
      </p>
      <a
        href="#experience"
